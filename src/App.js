...
return (
    ...
    <Navbar LogInStatus={this.state.userLoggedInStatus} onUserLogOut={this.onUserLogOut}/>
        ...
        <Route exact path='/home'component={ImgCard} />
       
        </Switch>
        
<Switch>

<Route exact path='/playvideo/:Vid' render={ routeprops=>this.state.userLoggedInStatus? <PlayVideo {...routeprops}/>: <Redirect to='/' />}/>
