...
<form onSubmit={this.onFormFill}>
        <input ref={this.UserRef} type='text'pattern="[A-Za-z0-9]+" name='Uname' placeholder='name' className={classess.box} required/>
        <p className={classess.nameErr} ref={this.myRef}>Please enter valid name</p>
        <input type='password' name='Pwd' placeholder='Password' className={classess.box} required/>
