...
<iframe className={classess.player} src={`https://player.vimeo.com/video/${this.state.data.vimeoId}`} frameBorder='0' webkitallowfullscreen='' mozallowfullscreen='' allowfullscreen=''></iframe>
</div>
